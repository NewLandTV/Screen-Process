...
{
	WindowApplication::Window window(hInstance, L"Start", L"StartWindowApp", 768, 432, WindowProcedure);
...
LRESULT CALLBACK WindowProcedure(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{
	case WM_CREATE:
		MoveWindow(hWnd, 0, 0, 768, 432, TRUE);
	...
	case WM_CHAR:
		...
		SendMessage(FindWindow(L"EndWindowApp", L"End"), WM_COPYDATA, NULL, (LPARAM)&copyDataStruct);
